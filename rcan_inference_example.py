...
def load_model(weights_path="rcan_full_3050ti_final.pth"):
...
def run_one_example(model, lr_path, hr_path, out_dir="examples_rcan_3050ti"):
    ...
    sr_save = os.path.join(out_dir, f"SR_patch_{base}_RCAN_3050ti.png")
...
if __name__ == "__main__":
    ...
    model = load_model()
    run_one_example(model, lr_path, hr_path, out_dir="examples_rcan_3050ti")